...
namespace DoctrineMongoODMModule\Proxy\__CG__\Application\Entity\Mongo;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Categories extends \Application\Entity\Mongo\Categories implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'alias', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'state', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'featured', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'menu', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'description', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'content', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'parent', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'created', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'updated', '' . "\0" . 'Application\\Entity\\Mongo\\Categories' . "\0" . 'author');
        }
